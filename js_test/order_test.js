/*
To test the place order process in JS format
...
var place_order = require('./httputils.js').place_order;

/*
Main function to palce the order for the input account
with the currency
1. Should check for possible errors before submit
   such as low balance, invalid issuer
The input information should have 
source account
currency
...
//input address and a certain balance
  ...
  // most likely, entropy sources are drained
    ...
    place_order(inServer, cur_payment.source_account, 
      in_data,
